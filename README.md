...
|`templating_user_test_cmd` | <code>%Q{ &#91; "Z$(stat -c "%%U" %&lt;path&gt;s 2&gt;/dev/null)" != "Z%&lt;user&gt;s" &#93; }</code> | Test command to check the remote file owner. |
|`templating_group_test_cmd`| <code>%Q{ &#91; "Z$(stat -c "%%G" %&lt;path&gt;s 2&gt;/dev/null)" != "Z%&lt;group&gt;s" &#93; }</code> | Test command to check the remote file group. |
...
1. Fork it ( https://github.com/jbox-web/capistrano-template/fork )
